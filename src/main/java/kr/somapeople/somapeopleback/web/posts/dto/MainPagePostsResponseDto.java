...
public class MainPagePostsResponseDto {
    ...
    public MainPagePostsResponseDto(List<PostsResponseDto> recentPostList, List<PostsResponseDto> qnaPostList, List<PostsResponseDto> freePostList, List<PostsResponseDto> applicantPostList) {
